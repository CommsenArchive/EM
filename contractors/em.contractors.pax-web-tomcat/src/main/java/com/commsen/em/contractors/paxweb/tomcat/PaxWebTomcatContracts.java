package com.commsen.em.contractors.paxweb.tomcat;
...
@Requires(raw="osgi.identity;filter:='(&(osgi.identity=org.ops4j.pax.web.pax-web-tomcat)(version=6.0.7))'")
@Requires(raw="osgi.service;filter:='(objectClass=org.osgi.service.http.HttpService)';effective:=active")
public class PaxWebTomcatContracts {}
